 ...
 * 
 * @uses actionHelper Escarmouche_Controller_ActionHelpers
 */
class Escarmouche_Controller_ActionHelpers_RedirectorToOrigin extends Zend_Controller_Action_Helper_Abstract
{
